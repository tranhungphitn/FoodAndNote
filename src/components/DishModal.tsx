    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 bg-black/60 backdrop-blur-xs">
        ...
        <motion.div
          ...
          className="relative w-full sm:max-w-4xl h-full sm:h-[85vh] max-h-full sm:max-h-[90vh] bg-white rounded-none sm:rounded-[28px] shadow-2xl flex flex-col overflow-hidden border-0 sm:border border-slate-100"
          id="dish-modal"
        >
